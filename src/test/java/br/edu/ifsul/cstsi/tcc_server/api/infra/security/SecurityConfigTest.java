...
public class SecurityConfigTest {
    ...
    void endPointConfirmarEmailQuandoVerboGetETokenValidoEspera200Ok() throws Exception {
        //ARRANGE
        var url = "/confirm-email?token=aecc73b7-dae5-4011-925d-e07633d9993f";
    ...
    void endPointConfirmarEmailQuandoVerboGetETokenInvalidoEspera400BadRequest() throws Exception {
        //ARRANGE
        var url = "/confirm-email?token=token_invalido";
    ...
    void endPointConfirmarEmailQuandoVerboPostPutEDeleteETokenValidoEspera403Forbidden() throws Exception {
        //ARRANGE
        var url = "/confirm-email?token=token=aecc73b7-dae5-4011-925d-e07633d9993f";
    ...
    @Test
    void endPointSeriesQuandoVerboGetPostPutDeleteENaoEstaAutenticadoEspera403Forbidden() throws Exception {
        //ARRANGE
